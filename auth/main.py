...
SECRET_KEY = "_MvHM-tBTK7yFHDtxfnBFfjMmW8dccaT2HX1wNdtGI0"
ALGORITHM = "HS256"
...
def user_dashboard(current_user = Depends(require_roles(["user"]))):
    return {"message": " welcome user"}

@app.get("/admin/dashboard")
def user_dashboard(current_user = Depends(require_roles(["admin"]))):
